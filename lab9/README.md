...
## Objectives:
- Study the GitHub repository [Lesson 9](https://github.com/kevinwlu/iot/tree/master/lesson9)
...
Collecting pyang
  Downloading pyang-2.5.3-py2.py3-none-any.whl (592 kB)
     ------------------------------------- 592.9/592.9 kB 18.2 MB/s eta 0:00:00
...
pip instSuccessfully installed lxml-4.9.2 pyang-2.5.3
al
```
```
...
Requirement already satisfied: httplib2 in c:\users\micha\appdata\local\programs\python\python311\lib\site-packages (from PlantUML) (0.22.0)
Requirement already satisfied: pyparsing!=3.0.0,!=3.0.1,!=3.0.2,!=3.0.3,<4,>=2.4.2 in c:\users\micha\appdata\local\programs\python\python311\lib\site-packages (from httplib2->PlantUML) (3.0.9)
...
center footer
 <size:20> UML Generated : 2023-05-06 15:37 </size>
 endfooter
@enduml
```
```
